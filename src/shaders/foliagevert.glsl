...
layout (location = 3) in float aColourmapX;
layout (location = 4) in float aColourmapY;

out vec3 normal;
out float textureID;
out vec2 texCoord;
out float colourmapX; // 0-256
out float colourmapY; // 0-256
...
void main() {
    ...
    colourmapX = aColourmapX;
    colourmapY = aColourmapY;
}